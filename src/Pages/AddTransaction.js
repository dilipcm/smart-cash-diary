...
function AddTransaction() {
  ...
  <div className='App'>
    ...
    <ThemeProvider theme={theme}>
      ...
      <Container component="main" maxWidth="xs" sx={{alignItems: 'left',}} gap={2}>
          <Paper container="true" >
            <CssBaseline />
              ...
              >
                ...
                <Box component="form" onSubmit={handleTransactionSubmit} id="transaction_form" display="grid" sx={{ mt:1,mx:4, width: '85%' }} gridTemplateColumns="repeat(12, 1fr)" gap={2}> 
                <Box gridColumn="span 12">
                  ...
                  <Box gridColumn="span 12">
                  <LocalizationProvider className ="FormGroup" dateAdapter={AdapterDateFns} fullWidth>
                    <Stack spacing={3}>
                      <DateTimePicker
                        required 
                    ...
                    <Box gridColumn="span 12">
                  <FormControl fullWidth>
                    <InputLabel id="transaction-type-label">Select Transaction Type</InputLabel>
                    <Select
